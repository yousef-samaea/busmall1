...
let cart = new Cart([]);  /// to add the selected later
...
function addSelectedItemToCart() {
  let selectQuan = document.getElementById('quantity').value;
  let selectElementValue=document.getElementById('items').value;
